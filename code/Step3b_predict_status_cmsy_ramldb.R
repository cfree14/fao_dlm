...
# Read data
id_file <- "ramldb_stock_info_key_for_cmsy_froese.csv"
catch_file <- "ramldb_stock_catch_time_series_for_cmsy_froese.csv"
cinfo <- read.csv(paste(datadir, id_file, sep="/"), as.is=T) 
cdata <- read.csv(paste(datadir, catch_file, sep="/"), as.is=T)

# Setup output file
outfile <- paste(preddir, "status_predictions_cmsy_froese3.csv", sep="/")
outfile.txt <- paste(preddir, "status_predictions_cmsy_froese3.txt", sep="/")

# Stocks to analyze
# 4 stocks didn't work the first time
# "AFSC-RKCRABBB-1960-2008-JENSEN", "NEFSC-BUTTERGOMCHATT-1965-2012-HIVELY",
# "NEFSC-WEAKFISHATLC-1981-2008-STANTON", "NWFSC-CHILISPCOAST-1892-2007-BRANCH" 
stocks <- rev(c("AFSC-RKCRABBB-1960-2008-JENSEN", "NEFSC-BUTTERGOMCHATT-1965-2012-HIVELY",
              "NEFSC-WEAKFISHATLC-1981-2008-STANTON", "NWFSC-CHILISPCOAST-1892-2007-BRANCH"))
