...
# MODIFIED BY CHRIS FREE
# I comment this out and specify the id/catch files in "Step3b_predict_status_cmsy"
...
# MODIFIED BY CHRIS FREE
# I comment this out and specify the stocks in "Step3b_predict_status_cmsy"
...
write.output <- F # set to TRUE if table with results in output file is wanted; expects years 2004-2010 to be available
